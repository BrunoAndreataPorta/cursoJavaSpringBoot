...
public class HomeController 
{
	...
	public String getProgrammer(@RequestParam int pid, Model m)
	{
	...
	@GetMapping("getProgrammerByName")
	public String getProgrammerByName(@RequestParam String pname, Model m)
	{
		m.addAttribute("result", repo.find(pname));
